...
class AutoAttack():
    ...
    def run_standard_evaluation_individual(self, x_orig, y_orig, bs=250, return_labels=False):
        # my addition - weird bug where second time method is called (i.e on second batch) attacks to run is set to square only
        ...
        self.verbose = True #my addition to turn off self.verbose = False, i want it to stay on every time the method is called

...
--mu 0.2 \
--gamma 1.25 \
--checkpoint checkpoints/pretraining/wikitext103/kmeanspectral-m.pt \
--moe_top_k 1 \
--wandb-flag \
--project-name ellipSMoE
"
echo "Training ..."
CUDA_VISIBLE_DEVICES='0,1,2,3' python -m torch.distributed.launch --master_port 5678 --nproc_per_node=4 --use_env train.py $args

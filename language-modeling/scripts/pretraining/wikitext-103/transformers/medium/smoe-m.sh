...
--mu 0.2 \
--gamma 1.25 \
--checkpoint /cm/archive/stefannvkp/smoe_checkpoints/checkpoints/pretraining/wikitext103/smoe-speedtest.pt \
"
echo "Training ..."
CUDA_VISIBLE_DEVICES='4,5,6,7' python -m torch.distributed.launch --master_port 10233 --nproc_per_node=4 --use_env train.py $args


# echo "Eval ..."
# CUDA_VISIBLE_DEVICES='0,2,3,7' python -m torch.distributed.launch --master_port 10233 --nproc_per_node=4 --use_env train.py $args --resume --full-eval-mode

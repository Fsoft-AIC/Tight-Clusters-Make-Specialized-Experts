...
--mu 0.2 \
--gamma 1.25 \
--checkpoint checkpoints/pretraining/wikitext103/ellgate-valweights-m.pt \
"
echo "Training ..."
CUDA_VISIBLE_DEVICES='0,1,2,3' python -m torch.distributed.launch --master_port 1678 --nproc_per_node=4 --use_env train.py $args --wandb-flag --project-name ellipSMoE


# echo "Eval ..."
# CUDA_VISIBLE_DEVICES='0,4,5,7' python -m torch.distributed.launch --master_port 5678 --nproc_per_node=4 --use_env train.py $args --resume --full-eval-mode

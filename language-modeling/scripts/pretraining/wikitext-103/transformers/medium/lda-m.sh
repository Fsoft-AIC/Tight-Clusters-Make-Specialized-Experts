...
--mu 0.2 \
--gamma 1.25 \
--checkpoint /home/stefannvkp/smoe/checkpoints/pretraining/wikitext103/lda-m.pt \
--show-gate-w-stats \
--debug \
"
echo "Training ..."
CUDA_VISIBLE_DEVICES='7' python -m torch.distributed.launch --master_port 9121 --nproc_per_node=1 --use_env train.py $args --wandb-flag --project-name ellipSMoE
